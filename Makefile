...
.PHONY: debug_run
debug_run: 360_debug_run 150_anno_debug_run 360_anno_debug_run
...
360_debug_run: data/360_merged_2.50_debug.vcf.gz_ib
150_anno_run: data/annotated_tomato_150.vcf.gz_ib
150_anno_debug_run: data/annotated_tomato_150_debug.vcf.gz_ib
360_anno_run: data/annotated_tomato_360.vcf.gz_ib
360_anno_debug_run: data/annotated_tomato_360_debug.vcf.gz_ib


data/360_merged_2.50.vcf.gz_ib: data/360_merged_2.50.vcf.gz
	$(PYTHON) ./reader.py $^ || (rm -rfv $@ && exit 1)

data/360_merged_2.50_debug.vcf.gz_ib: data/360_merged_2.50_debug.vcf.gz
...
data/annotated_tomato_150_debug.vcf.gz_ib: data/annotated_tomato_150_debug.vcf.gz.tsv data/annotated_tomato_150_debug.vcf.gz
	$(PYTHON) ./reader.py --debug --rename-tsv $^ || (rm -rfv $@ && exit 1)

data/annotated_tomato_360.vcf.gz_ib: data/annotated_tomato_360.vcf.gz
	$(PYTHON) ./reader.py $^ || (rm -rfv $@ && exit 1)

data/annotated_tomato_360_debug.vcf.gz_ib: data/annotated_tomato_360_debug.vcf.gz
	$(PYTHON) ./reader.py --debug $^ || (rm -rfv $@ && exit 1)
...
.PHONY: debug_clean
debug_clean: 360_debug_clean 150_anno_debug_clean 360_anno_debug_clean
...
360_debug_clean:
	rm -rfv data/360_merged_2.50_debug.vcf.gz_ib      || true

150_anno_clean:
	rm -rfv data/annotated_tomato_150.vcf.gz_ib       || true

150_anno_debug_clean:
	rm -rfv data/annotated_tomato_150_debug.vcf.gz_ib || true

360_anno_clean:
	rm -rfv data/annotated_tomato_360.vcf.gz_ib       || true

360_anno_debug_clean:
	rm -rfv data/annotated_tomato_360_debug.vcf.gz_ib || true
...
.PHONY: debug_download
debug_download: 360_debug_download 150_anno_debug_download 360_anno_debug_download

150_download: data/150_VCFs_2.50.tar.gz
360_download: data/360_merged_2.50.vcf.gz
360_debug_download: data/360_merged_2.50_debug.vcf.gz
150_anno_download: data/annotated_tomato_150.vcf.gz
150_anno_debug_download: data/annotated_tomato_150_debug.vcf.gz
360_anno_download: data/annotated_tomato_360.vcf.gz
360_anno_debug_download: data/annotated_tomato_360_debug.vcf.gz
...
data/360_merged_2.50_debug.vcf.gz: data/360_merged_2.50.vcf.gz
...
data/annotated_tomato_150_debug.vcf.gz: data/annotated_tomato_150.vcf.gz
	cd $(dir $<) && ln -s $(notdir $<) $(notdir $@)
...
data/annotated_tomato_360_debug.vcf.gz: data/annotated_tomato_360.vcf.gz
	cd $(dir $<) && ln -s $(notdir $<) $(notdir $@)

data/annotated_tomato_150_debug.vcf.gz.tsv: data/annotated_tomato_150.vcf.gz.tsv
	cd $(dir $<) && ln -s $(notdir $<) $(notdir $@)
